...
const getColumns = (props: ColumnProps) => {
  ...
  //                   type="view"
  //                   onClick={() => {
  //                     navigate(`/admin/report/view/${d?.id}`);
  //                     actions.togglePopup("edit");
  //                   }}
  //                 />
  //               )}
  ...
  //                   type="edit"
  //                   onClick={() => {
  //                     navigate(`/admin/report/edit/${d?.id}`);
  //                     actions.togglePopup("edit");
  //                   }}
  //                 />
  //               )}
...
const ContactTable = (props: ContactTableProps) => {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ["GET_CONTACT", param_payload, pathname],
    queryFn: () => getContact(param_payload),
    keepPreviousData: true,
  });
