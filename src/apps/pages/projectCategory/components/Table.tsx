...
import ModalEditIndustry from "./ModalEdit";
...
const getColumns = (props: ColumnProps) => {
    ...
    //permissions
    const { hasPermission } = usePermissionCheck("industry");
...
const IndustryTable = (props: IndustryTableProps) => {
    ...
    const { data, isLoading, isError, refetch } = useQuery({
        queryKey: ["GET_INDUSTRY", param_payload, pathname],
        queryFn: () => getIndustry(param_payload),
    ...
    useEffect(() => {
        ...
        if (pathname.includes("view") && !popup.edit) {
            navigate(`/admin/industry/view/${code}`);
            togglePopup("edit");
        }
