    ...
    >
      ...
      <div className="w-full flex gap-5 mt-6">
        <div className="flex flex-col gap-4 rounded-xl flex-grow">
          ...
          <div className="rounded-xl bg-white flex-grow p-4 shadow">
            <div className="flex justify-between items-center">
              <h3 className="text-lg">Đặt chỗ</h3>
              {/* <MyDatePicker date={date} setDate={setDate} /> */}
              <div className="flex gap-1">
                <div className="rounded-lg bg-[#F6FAF7] text-[var(--text-color-primary)] px-2 py-[6px]">
                  <FontAwesomeIcon icon={faAngleLeft} />
            ...
            {/* chart col year */}
            <ChartDashboard color="#875BF7" />
          </div>
          {/*  */}
          <div className="rounded-xl bg-white flex-grow p-4 shadow">
            <div className="flex justify-between items-center">
              <h3 className="text-lg">Thống kê lượt khách hàng</h3>
              {/* <MyDatePicker date={date} setDate={setDate} /> */}
              <div className="flex gap-1">
                <div className="rounded-lg bg-[#F6FAF7] text-[var(--text-color-primary)] px-2 py-[6px]">
                  <FontAwesomeIcon icon={faAngleLeft} />
            ...
            <div className="flex flex-wrap items-center gap-4 mt-[10px]">
              {LIST_CARD_2.map((item) => (
                <StatusCardV2
                  ...
                  customCss="calc(33% - 11px)"
                />
              ))}
            </div>
            {/* chart col year */}
            <ChartDashboard color="#D444F1" />
          </div>
          {/*  */}
          <div className="rounded-xl bg-white flex-grow p-4 shadow">
            <div className="flex justify-between items-center">
              <h3 className="text-lg">Top 5 dịch vụ được sử dụng nhiều nhất</h3>
              {/* <MyDatePicker date={date} setDate={setDate} /> */}
            </div>
        ...
        <div className="w-1/4 flex flex-col gap-4 !min-w-[320px]">
          ...
          <div className="rounded-xl bg-white p-4 shadow">
            <div className="flex flex-col">
              <h3 className="text-lg">Thống kê lịch hẹn</h3>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-[10px] w-full">
              {LIST_CARD_3.map((item) => (
                <StatusCardV2 key={item.key} statusData={item}   hightLine="label" customCss="w-full" />
              ))}
            </div>
          </div>
          {/*  */}
          <div className="rounded-xl bg-white  p-4  shadow">
            <div className="flex flex-col">
              <h3 className="text-lg">Thống kê lương của bạn</h3>
              <div className="flex gap-1 my-2.5 w-full">
                <div className="rounded-lg bg-[#F6FAF7] text-[var(--text-color-primary)] px-2 py-[6px]">
                  <FontAwesomeIcon icon={faAngleLeft} />
                </div>
