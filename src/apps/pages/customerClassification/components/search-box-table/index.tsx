...
export default function SearchBoxTable(props: SearchBoxTableProps) {
    ...
    return (
        <div className={styles.wrapper}>
            ...
            >
                <input
                    value={keySearch?.rank__like?.toString()}
                    onChange={(e) => {
                        setKeySearch({
                            // ...keySearch,
                            rank__like: e.target.value,
                        });
                    }}
                    className={styles.input}
                    placeholder="Tìm theo hạng khách hàng, trạng thái"
                />
                {keySearch?.rank__like && (
                    <Box
                        component={"span"}
                        sx={{
                            "> svg": {
                    ...
                    >
                        <FontAwesomeIcon
                            icon={faCircleXmark}
                            onClick={() => {
                                setKeySearch({ ...keySearch, rank__like: "" });
                            }}
                        />
                    </Box>
                )}
