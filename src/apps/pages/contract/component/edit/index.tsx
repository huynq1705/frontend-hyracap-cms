        ...
        <Stack direction={"column"} width={"100%"}>
          ...
          <ul className="pl-8">
            <li>
              ...
              <strong>
                {formatCurrency(+contractInfo?.product_id?.min_invest)}
              </strong>
            </li>
            <li>
              Hạn mức đầu tư tối đa:{" "}
              <strong>
                {formatCurrency(+contractInfo?.product_id?.max_invest)}
              </strong>
            </li>
            <li>
              Thời hạn tối thiểu:{" "}
              <strong>{contractInfo?.product_id?.min_duration} tháng</strong>
            </li>
            <li>
              Thời hạn tối đa:{" "}
              <strong>{contractInfo?.product_id?.max_duration} tháng</strong>
            </li>
            <li>
              Lãi suất:{" "}
              <strong>
                {(+contractInfo?.product_id?.current_interest_rate).toFixed(2)}%
              </strong>
            </li>
          </ul>
        </Stack>
