    ...
    try {
      ...
      if (response) {
        ...
        const convert_data = {
          ...
          funding_amount: response.data.project_information.funding_amount,
          total_slots: response.data.project_information.total_slots,
          price_per_slot: response.data.project_information.price_per_slot,
          investors: response.data.project_information.investors,
          funding_round: response.data.project_information.funding_round,
          investment_field: response.data.company_information.investment_field,
          date_of_establishment:
            response.data.company_information.date_of_establishment,
          head_office: response.data.company_information.head_office,
          operating_status: response.data.company_information.operating_status,
          founder: response.data.company_information.founder,
          company_name: response.data.company_information.company_name,
          ...
          pitching_deck:
            response.pitching_deck === null ? [""] : [response.pitching_deck],
          contract_template:
          ...
          business_plan:
            response.business_plan === null ? [""] : [response.business_plan],
        };
      ...
      >
        ...
        >
          ...
          >
            ...
            {isEdit && <ButtonCore onClick={handleUpdate} title={"Hoàn tất"} />}
          </Stack>
        </Stack>
        <Box
          sx={{
          ...
          >
            ...
            <Stack direction={"row"} className="w-full justify-between">
              <div className="flex flex-col w-[calc(20%-12px)]   ">
                ...
                {(formData.images.length > 0 || isFirstRemoved) && (
                  <UploadImage
              ...
              <div className="flex flex-col w-[calc(20%-12px)]">
                ...
                {(formData.pitching_deck.length > 0 || isFirstRemoved) && (
                  <UploadFile
              ...
              <div className="flex flex-col w-[calc(20%-12px)]">
                ...
                {(formData.contract_template.length > 0 || isFirstRemoved) && (
                  <UploadFile
                    key="upload_image_contract_template"
                    setImgUrl={handleChangeImage("contract_template")}
              ...
              <div className="flex flex-col w-[calc(20%-12px)]">
                ...
                {(formData.financial_roadmap.length > 0 || isFirstRemoved) && (
                  <UploadFile
                    key="upload_image_financial_roadmap"
                    setImgUrl={handleChangeImage("financial_roadmap")}
              ...
              <div className="flex flex-col w-[calc(20%-12px)]">
                ...
                {(formData.business_plan.length > 0 || isFirstRemoved) && (
                  <UploadFile
