...
export interface ResponsePrepaidCardFaceItem extends BaseItemResponse {
  quantity: number;
  price: number;
  amount: number;
  type: number;
  ...
  service_id: any;
  order: Order;
  prepaid_card_face_value: PrepaidCardFaceValue;
  order_detail_prepaid_card: any[];
}
...
export interface PrepaidCardFaceValue {
  id: number;
  created_at: string;
  updated_at: string;
  is_active: boolean;
